...
function Logo() {
  return (
    <div className="absolute contents left-[66px] top-[130px]" data-name="logo">
      ...
      <p className="[word-break:break-word] absolute bg-clip-text bg-gradient-to-r font-['Baloo:Regular',sans-serif] from-[#8b5bc5] h-[76px] leading-[normal] left-[137px] not-italic text-[50px] text-[transparent] to-[#fb9b44] top-[130px] via-1/2 via-[#eb7f9e] w-[203px]">Monetra</p>
    </div>
  );
}
