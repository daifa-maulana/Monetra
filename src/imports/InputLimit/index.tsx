import svgPaths from "./svg-j4vhdecyw8";
import imgCdef7C789Cc967E560Fca00F07901E9E4 from "./c45dba6774961b79db46eabcdb4d29add249dcee.png";
import img9B71E502Ecda40518BbeC4079881D6621 from "./8e8b119f2f023ad66ed8fe55ced43a67598e76f7.png";
...
function Group10() {
  return (
    <div className="absolute left-[77px] top-[356px] w-[255px] h-[56px]">
      ...
      <div className="absolute -translate-y-1/2 flex flex-col justify-center left-[56px] text-[#5b5b5b] text-[10px] top-[28px] w-[192px] whitespace-pre-wrap font-['SF_Pro:Medium',sans-serif] font-[510]">
        <p className="leading-[normal] mb-0">{`Atur limit sesuai kebutuhanmu agar `}</p>
        <p className="leading-[normal]">keuanganmu tetap terkontrol</p>
      </div>
      <div className="absolute left-[15px] top-[15px] w-[27px] h-[25px]" data-name="Vector">
        <svg className="block size-full" fill="none" viewBox="0 0 27.5974 25">
          <path d={svgPaths.p1f269d00} fill="#7459D0" id="Vector" />
        </svg>
      </div>
    </div>
  );
      ...
      <div className="-translate-x-1/2 absolute left-[calc(50%+1px)] size-[59px] top-[778px]">
        <div className="absolute inset-[-6.78%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 67 67">
            <g filter="url(#filter0_d_1_100)" id="Ellipse 5">
              <circle cx="33.5" cy="33.5" fill="var(--fill-0, white)" r="29.5" />
            </g>
            <defs>
              <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="67" id="filter0_d_1_100" width="67" x="0" y="0">
...
export default function InputLimit({ 
  userId, 
  onBack,
  onNavigateDashboard,
  onNavigateRecap,
  ...
  useEffect(() => {
    const fetchCurrentLimit = async () => {
      const { data, error } = await supabase
        .from("rekening")
        .select("limit_pengeluaran")
        .eq("user_id", userId)
        .limit(1);
      
      if (!error && data && data.length > 0) {
        if (data[0].limit_pengeluaran > 0) {
          setRawAmount(data[0].limit_pengeluaran.toString());
        }
      }
    };
    fetchCurrentLimit();
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      alert("Gagal menyimpan batas pengeluaran");
    } finally {
      setSaving(false);
    }
  };
  ...
  return (
    <div className="bg-[#fdfdff] overflow-clip relative rounded-[30px] size-full" data-name="Input Limit">
      <p className="[word-break:break-word] absolute font-['SF_Pro:Bold',sans-serif] font-bold h-[27px] leading-[normal] left-[36px] text-[18px] text-black top-[19px] w-[64px]" style={{ fontVariationSettings: '"wdth" 100' }}>
        10:45
      </p>
      <div className="absolute h-[51px] left-[279px] top-[7px] w-[91px]" data-name="cdef7c789cc967e560fca00f07901e9e 4">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgCdef7C789Cc967E560Fca00F07901E9E4} />
      </div>
      ...
      <p className="[word-break:break-word] absolute font-['SF_Pro:Medium',sans-serif] font-[510] leading-[normal] left-[74px] text-[11px] text-white top-[123px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
        Atur batas pengeluaran bulananmu
      </p>
      ...
      <div className="absolute flex h-[82.728px] items-center justify-center left-[260px] top-[117px] w-[109.08px]">
        <div className="flex-none rotate-[-5.02deg]">
          <div className="h-[74px] relative w-[103px]" data-name="9b71e502-ecda-4051-8bbe-c4079881d662 1">
            <img alt="" className="absolute inset-0 max-w-none object-bottom pointer-events-none size-full" src={img9B71E502Ecda40518BbeC4079881D6621} />
          </div>
        </div>
      </div>
      <Group16 />
